...
FROM maven:3.9.8-eclipse-temurin-17-focal AS package
...
RUN mv xtable-utilities/target/xtable-utilities_2.13-$(mvn help:evaluate -Dexpression=project.version -q -DforceStdout)-bundled.jar target/app.jar
